  ...
  return (
    <div className="hud">
      ...
      <div className="hud-buttons">
        ...
        <button
          className={`hud-btn ${showModes ? "hud-btn-pink" : "hud-btn-dim"}`}
          onClick={onToggleModesPanel}
          aria-label={showModes ? "Hide hardcore modes" : "Show hardcore modes"}
        >
